...
namespace Cyberevolver.EditorUnity
{
    ...
    public  static class TheEditor 
    {
        ...
        public static Texture2D GroupHeaderTexture { get; private set; }
        ...
        {
            GroupHeaderTexture = GetHeaderTexture();
        }
    ...
    private class GuiRemeber
            ...
            ,bool drawExpand=true,bool drawSize=true,bool indentLv=true , string[] customNames=null)
        {
            bool DrawFoldout()
            {
                ...
                rect.height = 20;
                bool wasPrefix = DrawPrefix(content, fieldInfo) == false;
        ...
        public static void DrawBoxHeader(GUIContent content, GUIStyle labelStyle = null)
        {
            EditorGUILayout.BeginVertical(TheEditor.GroupHeaderStyle);
