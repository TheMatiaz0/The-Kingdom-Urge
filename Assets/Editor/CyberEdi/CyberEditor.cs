...
namespace Cyberevolver.EditorUnity
{
    ...
    public sealed class CyberEdit 
    {
        ...
        private readonly  Dictionary<(MemberInfo, string), object> globalValues = new Dictionary<(MemberInfo, string), object>();
        ...
        public void SetGlobalValue(MemberInfo field, string code, object value)
        {
            globalValues.AddOrSet((field, code), value);
        }
        public object GetGlobalValue(MemberInfo field, string code)
        {
        ...
        public void Active()
        {
            ...
            members =  GetTotalFields(targetType);
